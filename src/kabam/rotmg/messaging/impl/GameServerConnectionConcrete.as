...
package kabam.rotmg.messaging.impl
{
    ...
    public class GameServerConnectionConcrete extends GameServerConnection 
    {
        ...
        override public function disconnect():void
        {
            ...
            {
                this.chatServerConnection.chatDisconnect();
            };
        }
        ...
        public function mapMessages():void
        {
            ...
            _local_1.map(CHAT_HELLO_MSG).toMessage(ChatHello);
            ...
            _local_1.map(CHAT_TOKEN_MSG).toMessage(ChatToken).toMethod(this.onChatToken);
        ...
        private function encryptConnection():void
        {
            ...
            {
                serverConnection.setOutgoingCipher(Crypto.getCipher("rc4", MoreStringUtil.hexStringToByteArray("6a39570cc9de4ec71d64821894c79332b197f92ba85ed281a023".substring(0, 26))));
                serverConnection.setIncomingCipher(Crypto.getCipher("rc4", MoreStringUtil.hexStringToByteArray("6a39570cc9de4ec71d64821894c79332b197f92ba85ed281a023".substring(26))));
        ...
        override public function playerText(_arg_1:String):void
        {
            ...
            this.chatServerConnection.sendMessage(_local_2);
        }
        ...
        {
            var _local_1:ChatHello = (this.messages.require(CHAT_HELLO_MSG) as ChatHello);
