...
package com.company.assembleegameclient.game
{
    ...
    public class GameSprite extends AGameSprite 
    {
        ...
        override public function initialize():void
        {
            ...
            {
                _local_4 = (this.mapModel.currentInteractiveTarget as Portal);
                if (_local_4)
                {
                    _local_5 = _local_4.name_;
                };
            ...
            else
            {
                ...
                {
                    _local_7 = StaticInjectorContext.getInjector().getInstance(ShowProTipSignal);
                    ((_local_7) && (_local_7.dispatch()));
                };
            };
